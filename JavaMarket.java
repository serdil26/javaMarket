...
public class JavaMarket {
	...
	public static void main(String[] args) {
		...
		sepeteEkle(urunNo, kilo);
		toplamFiyat= sepetTutari ();
		 System.out.println("devam edecekseiniz E yazin");
			devam= scan.nextLine();
	...
	private static double sepetTutari() {
		...
		System.out.println("Toplam odemeniz gereken tutar: "+ sepetTutari);
		return sepetTutari;
	}
	...
	private static void odeme(double toplamFiyat) {
		...
		double nakit=0;
		do {
			System.out.println("Lutfen odeme tutarinizi giriniz: ");
	...
	private static void sepeteEkle(int urunNo, double kilo) {
		sepetUrunlerin.add(urunler.get(urunNo));
		sepetKg.add(kilo);
		sepetFiyatlar.add(fiyatlar.get(urunNo)*kilo);
